...
class Constant {
    companion object {
        ...
        fun onTextChange1(context: Context, edtText: EditText, errorText: TextView) {
            edtText.addTextChangedListener(object : TextWatcher {
                override fun beforeTextChanged(
                    s: CharSequence?,
                    start: Int,
        ...
        fun onTextChangeMiddleName1(context: Context, edtText: EditText, btnRebate: TextView) {
            edtText.addTextChangedListener(object : TextWatcher {
                override fun beforeTextChanged(
                    s: CharSequence?,
                    start: Int,
        ...
        fun setRebateBtnEnable(btnRebate: TextView) {
            btnRebate.isEnabled = true
            btnRebate.setBackgroundResource(R.drawable.bg_button)
        }

        fun setRebateBtnDisable(btnRebate: TextView) {
            btnRebate.isEnabled = false
            btnRebate.setBackgroundResource(R.drawable.bg_button_disable)
        }
    }
}