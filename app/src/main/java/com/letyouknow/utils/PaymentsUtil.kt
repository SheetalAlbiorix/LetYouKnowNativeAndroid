...
object PaymentsUtil {
    ...
    private fun gatewayTokenizationSpecification(): JSONObject {
        return JSONObject().apply {
            ...
            put("parameters", JSONObject(Constant.PAYMENT_GATEWAY_TOKENIZATION_PARAMETERS))
        }
    }
     ...
     */
    private val allowedCardNetworks = JSONArray(Constant.SUPPORTED_NETWORKS)
     ...
     * See [CardParameters](https://developers.google.com/pay/api/android/reference/object.CardParameters)
     */
    private val allowedCardAuthMethods = JSONArray(Constant.SUPPORTED_METHODS)
    ...
    fun createPaymentsClient(context: Context): PaymentsClient {
        val walletOptions = Wallet.WalletOptions.Builder()
            .setEnvironment(Constant.PAYMENTS_ENVIRONMENT)
            .build()
    ...
    private fun getTransactionInfo(price: String): JSONObject {
        return JSONObject().apply {
            ...
            put("countryCode", Constant.COUNTRY_CODE)
            put("currencyCode", Constant.CURRENCY_CODE)
        }
    }
